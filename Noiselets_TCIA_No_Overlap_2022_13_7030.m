...
FolderResults =     '/mnt/md0/ricardo/NoiseletProject/ResultsTCIA_Norm_2022_new_NoOverlap/'; %folder Out
mkdir(FolderResults)
...
FolderIMG = '/mnt/md0/Histopathology/Datasets/DatasetTCIA_NORM_new/';   
