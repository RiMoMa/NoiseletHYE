...
%%%%%%%%% Folder Results %%%%%%%%
FolderResults = '/mnt/md0/ricardo/NoiseletProject/ResultsNoiselets_Original_Complete_noOverlap_Monuseg_ecDist_hover/'; %folder Out'
...
FolderImagesTest  = [FolderResults,'AllTestImages/']; %% borderline groundtruth
mkdir(FolderImagesTest);
%%%%%%%%%%%%%%%%%%%%%%%%%
...
MaskCompleteFolder = '/mnt/md0/ricardo/NoiseletProject/NoiseletHYE/Tissue_Masks';
MaskNoiseletFolder = '/home/ricardo/testHovernet_masks/mat/';
...
toc
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       ...
       try
        ...
        FolderTestImg = strcat(FolderImagesTest,'/',ExpeName,'_Fold_',num2str(OneOut),'/');
        mkdir(FolderTestImg)
        
        PathImgTestOut = strcat(FolderTestImg,ImgTestS,'.png');
        imwrite(ImEnhance,PathImgTestOut)
...
% MaskOriginal = load([MaskCompleteFolder,ImgTestS,'.mat'] ).inst_map;
% MaskEvaluate = load([MaskNoiseletFolder ,ImgTestS,'.mat']).inst_map;
