function [nuclei properties] = nucleiSegmentation(I, varargin)
...
idx = mergeContours(nuclei, fitness, p.Th, centroids);
...
function idx = mergeContours(C, fitness, Th, centroids)
