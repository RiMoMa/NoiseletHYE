...
dL = 20; % Mean in pixels of a typical small nuclei diameter
Kparameter = [10,20,30]; % Pixel Radious to be multiplied with dL
...
%       thhreshold = 8 is the diameter of a Nuclei (mean) and multiply by 5
