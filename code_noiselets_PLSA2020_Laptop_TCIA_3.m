...
addpath('/home/ricardo/Documentos/DoctoradoExperimentos/CodesInternship/GITP/')
...
%%% Dataset Dir %%%
FolderIMG = '/home/ricardo/Documentos/DoctoradoExperimentos/Datasets/TCIA/';
FolderXML = '/mnt/md0/Histopathology/Datasets/MoNuSeg/Annotations/';


%% Folder Results
FolderResults = '/home/ricardo/Documentos/DoctoradoExperimentos/NoiseletProjects/ResultsTCIA2021/';
mkdir(FolderResults)
...
for Expe = 65:96%length(ExperimentosNoiselets)
...
ImBorde = imoverlay(ImTest,boundarymask(ImManualMask>0));
