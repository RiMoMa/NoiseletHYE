...
allImg = dir('/home/ricardo/Documents/Doctorado/NucleosMTC/DatasetTCIA/manual_segmentation_data/*crop.png');
...
for n =1:length(allImg)
    fprintf('%d de %d\n',n,length(allImg))
    %abre imagen
   im = imread([FolderDataset,'/',allImg(n).name]);
...
save(['BasesDatasetTCIA_All_.mat'],'BasesHE','BasesMaxC')
...
FolderData = '/home/ricardo/Documents/Doctorado/DatasetTCIA_NORM_new_All/';
mkdir(FolderData)
FolderComposed = ['/home/ricardo/Documents/Doctorado/DatasetTCIA_Norm_groups_All/'];
