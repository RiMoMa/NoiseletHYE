...
for ClassExp = 13%:length(clasesMonu) %realizar experimento por clase
 ...
 SelClassA=char(SelClass);   
    %% Folder Results
FolderResults = '//mnt/md0/ricardo/NoiseletProject/Results_SVM_2021_TCIA/';
mkdir(FolderResults)
FolderImgsMethod = [FolderResults,'ImgsMethodRed2/',SelClassA,'/'];
mkdir(FolderImgsMethod);
FolderImgsOriginal = [FolderResults,'ImgsOriginalRed2/',SelClassA,'/'];
mkdir(FolderImgsOriginal);
FolderImgsSumado  = [FolderResults,'ImgsSumadoRed2/',SelClassA,'/'];
mkdir(FolderImgsSumado);
FolderImgsSinRuido  = [FolderResults,'ImgsSinRuidoRed2/',SelClassA,'/'];
mkdir(FolderImgsSinRuido);
FolderImgsGroundTruth  = [FolderResults,'ImgsGrounTruth2/',SelClassA,'/'];
mkdir(FolderImgsGroundTruth);
