...
FolderIMG = '/mnt/storage/ramoncayomar/Datasets/PanNuke_Dataset/Fold1/DatasetImgs/';
FolderXML = '/mnt/storage/ramoncayomar/Datasets/PanNuke_Dataset/Fold1/MasksImgs/';
...
for Lo = 1:length(ListImgsTrain)
    ...
    ImgTrainNameMask = num2str(ListImgsTrainMask{Lo});
    fprintf('AbriendoImagen\n') 
    fprintf('%s\n',ImgTrainName) 
